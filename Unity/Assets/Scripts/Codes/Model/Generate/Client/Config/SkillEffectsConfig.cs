...
public sealed partial class SkillEffectsConfig: Bright.Config.BeanBase
{
    public SkillEffectsConfig(ByteBuf _buf) 
    {
        Id = _buf.ReadInt();
    ...
    public static SkillEffectsConfig DeserializeSkillEffectsConfig(ByteBuf _buf)
    {
        return new SkillEffectsConfig(_buf);
    }
    ...
    public const int __ID__ = -603730893;
