...
namespace ET
{
    ...
    public class SpellPreviewComponent : Entity,IAwake<Dictionary<string,int>>,IAwake,IOpera,IDestroy
    {
        ...
        public Dictionary<string, SkillAbility> InputSkills { get;  } = new Dictionary<string, SkillAbility>();
