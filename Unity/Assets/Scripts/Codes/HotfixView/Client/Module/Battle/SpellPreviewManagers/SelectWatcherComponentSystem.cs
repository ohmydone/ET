...
namespace ET.Client
{
    ...
    [FriendOf(typeof(SelectWatcherComponent))]
    public static class SelectWatcherComponentSystem
    {
        ...
        {
            protected override void Awake(SelectWatcherComponent self)
            {
        ...
        {
	        protected override void Load(SelectWatcherComponent self)
            {
                self.Init();
            }
        }
        ...
        {
	        var types = EventSystem.Instance.GetTypes(TypeInfo<SelectSystemAttribute>.Type);
