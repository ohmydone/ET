...
namespace ET
{
    ...
    [FriendOf(typeof(InputWatcherComponent))]
    public static class InputWatcherComponentSystem
    {
        ...
        {
            protected override void Awake(InputWatcherComponent self)
            {
        ...
        {
            protected override void Load(InputWatcherComponent self)
            {
                self.Init();
            }
        }
        ...
        {
            self.typeSystems = new TypeSystems(7);
            ...
            HashSet<Type> types = EventSystem.Instance.GetTypes(TypeInfo<InputSystemAttribute>.Type);
