...
namespace ET
{
    public class PlayEffectBehaviour : PlayableBehaviour
    {
       GameObject m_Instance;
        ...
        public static ScriptPlayable<PlayEffectBehaviour> Create(PlayableGraph graph, GameObject prefabGameObject, Transform parentTransform)
        {
            if (prefabGameObject == null)
                return ScriptPlayable<PlayEffectBehaviour>.Null;

            var handle = ScriptPlayable<PlayEffectBehaviour>.Create(graph);
...
#endif
                {
                    m_Instance =UnityEngine.Object.Instantiate(prefabGameObject, parentTransform, false);
                }
